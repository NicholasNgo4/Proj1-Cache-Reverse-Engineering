#!/bin/bash
#
# hw1_broadwell.sh -- Phase III Hazel pilot job, broadwell generation.
#
...
#SBATCH --output=data_raw/hazel_broadwell/hw1_broadwell_%j.log
#SBATCH --error=data_raw/hazel_broadwell/hw1_broadwell_%j.err.log
#SBATCH --ntasks=1
...
echo "SLURM_JOB_CONSTRAINT (feature match)=${SLURM_JOB_CONSTRAINT:-broadwell}"
