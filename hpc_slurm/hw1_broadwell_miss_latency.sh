#!/bin/bash
#
# hw1_broadwell_miss_latency.sh -- Phase-I miss/next-level-latency experiment,
# broadwell generation, via scripts/run_miss_latency_full.sh (HAZEL_MODE=1).
# Same boundary values as the other broadwell experiments (see
# data_raw/hazel_broadwell/README.md's capacity/ section). Three transitions,
...
#SBATCH --output=data_raw/hazel_broadwell/hw1_broadwell_miss_latency_%j.log
#SBATCH --error=data_raw/hazel_broadwell/hw1_broadwell_miss_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_miss_latency_full.sh hazel_broadwell "${CORE:-0}" \
  L1_to_L2:32768:262144,L2_to_LLC:262144:25874000,LLC_to_DRAM:25874000:536870912
