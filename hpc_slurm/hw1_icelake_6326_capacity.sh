#!/bin/bash
#
# hw1_icelake_6326_capacity.sh -- Phase-I capacity experiment, icelake_6326 generation,
...
#SBATCH --output=data_raw/hazel_icelake_6326/hw1_icelake_6326_capacity_%j.log
#SBATCH --error=data_raw/hazel_icelake_6326/hw1_icelake_6326_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_icelake_6326 "${CORE:-0}"
