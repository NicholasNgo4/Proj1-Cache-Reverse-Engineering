#!/bin/bash
#
# hw1_icelake_6326_miss_latency.sh -- Phase-I miss/next-level-latency experiment,
# icelake_6326 generation, via scripts/run_miss_latency_full.sh (HAZEL_MODE=1).
# Same boundary values as the other icelake_6326 experiments (see
# data_raw/hazel_icelake_6326/README.md's capacity/ section). Three transitions,
...
#SBATCH --output=data_raw/hazel_icelake_6326/hw1_icelake_6326_miss_latency_%j.log
#SBATCH --error=data_raw/hazel_icelake_6326/hw1_icelake_6326_miss_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_miss_latency_full.sh hazel_icelake_6326 "${CORE:-0}" \
  L1_to_L2:32768:1310720,L2_to_LLC:1310720:25874000,LLC_to_DRAM:25874000:536870912
