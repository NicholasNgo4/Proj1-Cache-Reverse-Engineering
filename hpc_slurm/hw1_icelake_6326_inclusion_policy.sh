#!/bin/bash
#
# hw1_icelake_6326_inclusion_policy.sh -- Phase-I inclusion/exclusion experiment,
# icelake_6326 generation, via scripts/run_inclusion_policy_full.sh (HAZEL_MODE=1).
# Same boundary values as the other icelake_6326 experiments (see
# data_raw/hazel_icelake_6326/README.md's capacity/ section): L1=32768 B
# (confirmed), L2=262144 B (reasoned), LLC=25165824 B / 24 MiB (provisional).
# ASSUMED_LINE_SIZE_BYTES left at its default (64) -- icelake_6326's own
...
#     hpc_slurm/hw1_icelake_6326_inclusion_policy.sh
#
#SBATCH --job-name=hw1_inclusion_policy
#SBATCH --output=data_raw/hazel_icelake_6326/hw1_icelake_6326_inclusion_policy_%j.log
#SBATCH --error=data_raw/hazel_icelake_6326/hw1_icelake_6326_inclusion_policy_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_inclusion_policy_full.sh hazel_icelake_6326 "${CORE:-0}" \
  L1_vs_L2:32768:1310720:L1_to_L2,L2_vs_LLC:1310720:25874000:L2_to_LLC,L1_vs_LLC:32768:25874000:LLC_to_DRAM
