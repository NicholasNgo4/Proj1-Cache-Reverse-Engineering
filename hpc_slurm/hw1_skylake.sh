#!/bin/bash
#
# hw1_skylake.sh -- Phase III Hazel pilot job, skylake generation.
#
...
#SBATCH --output=data_raw/hazel_skylake/hw1_skylake_%j.log
#SBATCH --error=data_raw/hazel_skylake/hw1_skylake_%j.err.log
#SBATCH --ntasks=1
...
echo "SLURM_JOB_CONSTRAINT (feature match)=${SLURM_JOB_CONSTRAINT:-skylake}"
