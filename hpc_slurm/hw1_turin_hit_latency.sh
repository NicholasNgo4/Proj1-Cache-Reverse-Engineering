#!/bin/bash
#
# hw1_turin_hit_latency.sh -- Phase-I hit-latency experiment, turin
...
#SBATCH --output=data_raw/hazel_turin/hw1_turin_hit_latency_%j.log
#SBATCH --error=data_raw/hazel_turin/hw1_turin_hit_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_hit_latency_full.sh hazel_turin "${CORE:-0}" \
  L1:49152,L2:1048576,LLC:33554432,DRAM:536870912
