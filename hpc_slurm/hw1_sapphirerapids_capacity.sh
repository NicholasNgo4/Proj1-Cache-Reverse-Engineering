#!/bin/bash
#
# hw1_sapphirerapids_capacity.sh -- Phase-I capacity experiment, sapphirerapids generation,
...
#SBATCH --output=data_raw/hazel_sapphirerapids/hw1_sapphirerapids_capacity_%j.log
#SBATCH --error=data_raw/hazel_sapphirerapids/hw1_sapphirerapids_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_sapphirerapids "${CORE:-0}"
