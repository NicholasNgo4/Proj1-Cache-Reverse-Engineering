#!/bin/bash
#
# hw1_icelake_8358_capacity.sh -- Phase-I capacity experiment, icelake_8358 generation,
...
#SBATCH --output=data_raw/hazel_icelake_8358/hw1_icelake_8358_capacity_%j.log
#SBATCH --error=data_raw/hazel_icelake_8358/hw1_icelake_8358_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_icelake_8358 "${CORE:-0}"
