#!/bin/bash
#
# hw1_turin_line_size.sh -- Phase-I line-size experiment, turin
# generation, via scripts/run_line_size.sh (HAZEL_MODE=1). Boundaries used
# (see data_raw/hazel_turin/README.md's capacity/ section for how each
# was derived): L1=49152 B (best-guess -- NOT 32768B, see capacity findings), L2=1048576 B (reasoned --
# NOT independently confirmed this pass, no visible L2 knee in the capacity
# sweep), LLC=33554432 B / 32 MiB (best-guess edge; the LLC->DRAM
...
#SBATCH --output=data_raw/hazel_turin/hw1_turin_line_size_%j.log
#SBATCH --error=data_raw/hazel_turin/hw1_turin_line_size_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_line_size.sh hazel_turin "${CORE:-0}" 49152,1048576,33554432
