#!/bin/bash
#
# hw1_icelake_8358_line_size.sh -- Phase-I line-size experiment, icelake_8358
# generation, via scripts/run_line_size.sh (HAZEL_MODE=1). Boundaries used
# (see data_raw/hazel_icelake_8358/README.md's capacity/ section for how each
...
# sweep), LLC=50331648 B / 48 MiB (best-guess placeholder, capacity data too noisy to resolve; the LLC->DRAM
...
#SBATCH --output=data_raw/hazel_icelake_8358/hw1_icelake_8358_line_size_%j.log
#SBATCH --error=data_raw/hazel_icelake_8358/hw1_icelake_8358_line_size_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_line_size.sh hazel_icelake_8358 "${CORE:-0}" 32768,1310720,50331648
