#!/bin/bash
#
# hw1_icelake_6326.sh -- Phase III Hazel pilot job, icelake_6326 generation.
#
...
#SBATCH --output=data_raw/hazel_icelake_6326/hw1_icelake_6326_%j.log
#SBATCH --error=data_raw/hazel_icelake_6326/hw1_icelake_6326_%j.err.log
#SBATCH --ntasks=1
...
echo "SLURM_JOB_CONSTRAINT (feature match)=${SLURM_JOB_CONSTRAINT:-icelake_6326}"
