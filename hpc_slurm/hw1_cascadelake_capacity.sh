#!/bin/bash
#
# hw1_cascadelake_capacity.sh -- Phase-I capacity experiment, cascadelake generation,
...
#SBATCH --output=data_raw/hazel_cascadelake/hw1_cascadelake_capacity_%j.log
#SBATCH --error=data_raw/hazel_cascadelake/hw1_cascadelake_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_cascadelake "${CORE:-0}"
