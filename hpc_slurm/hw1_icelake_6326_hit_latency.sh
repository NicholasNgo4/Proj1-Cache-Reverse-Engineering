#!/bin/bash
#
# hw1_icelake_6326_hit_latency.sh -- Phase-I hit-latency experiment, icelake_6326
...
#SBATCH --output=data_raw/hazel_icelake_6326/hw1_icelake_6326_hit_latency_%j.log
#SBATCH --error=data_raw/hazel_icelake_6326/hw1_icelake_6326_hit_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_hit_latency_full.sh hazel_icelake_6326 "${CORE:-0}" \
  L1:32768,L2:1310720,LLC:25874000,DRAM:536870912
