#!/bin/bash
#
# hw1_turin_inclusion_policy.sh -- Phase-I inclusion/exclusion experiment,
# turin generation, via scripts/run_inclusion_policy_full.sh (HAZEL_MODE=1).
# Same boundary values as the other turin experiments (see
# data_raw/hazel_turin/README.md's capacity/ section): L1=32768 B
# (confirmed), L2=262144 B (reasoned), LLC=25165824 B / 24 MiB (provisional).
# ASSUMED_LINE_SIZE_BYTES left at its default (64) -- turin's own
...
#     hpc_slurm/hw1_turin_inclusion_policy.sh
#
#SBATCH --job-name=hw1_inclusion_policy
#SBATCH --output=data_raw/hazel_turin/hw1_turin_inclusion_policy_%j.log
#SBATCH --error=data_raw/hazel_turin/hw1_turin_inclusion_policy_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_inclusion_policy_full.sh hazel_turin "${CORE:-0}" \
  L1_vs_L2:49152:1048576:L1_to_L2,L2_vs_LLC:1048576:33554432:L2_to_LLC,L1_vs_LLC:49152:33554432:LLC_to_DRAM
