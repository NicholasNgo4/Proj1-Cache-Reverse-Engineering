#!/bin/bash
#
# hw1_skylake_miss_latency.sh -- Phase-I miss/next-level-latency experiment,
# skylake generation, via scripts/run_miss_latency_full.sh (HAZEL_MODE=1).
# Same boundary values as the other skylake experiments (see
# data_raw/hazel_skylake/README.md's capacity/ section). Three transitions,
...
#SBATCH --output=data_raw/hazel_skylake/hw1_skylake_miss_latency_%j.log
#SBATCH --error=data_raw/hazel_skylake/hw1_skylake_miss_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_miss_latency_full.sh hazel_skylake "${CORE:-0}" \
