#!/bin/bash
#
# hw1_sapphirerapids_hit_latency.sh -- Phase-I hit-latency experiment, sapphirerapids
...
#SBATCH --output=data_raw/hazel_sapphirerapids/hw1_sapphirerapids_hit_latency_%j.log
#SBATCH --error=data_raw/hazel_sapphirerapids/hw1_sapphirerapids_hit_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_hit_latency_full.sh hazel_sapphirerapids "${CORE:-0}" \
  L1:49152,L2:2097152,LLC:39903168,DRAM:536870912
