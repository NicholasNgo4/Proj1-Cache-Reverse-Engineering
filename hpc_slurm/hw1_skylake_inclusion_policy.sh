#!/bin/bash
#
# hw1_skylake_inclusion_policy.sh -- Phase-I inclusion/exclusion experiment,
# skylake generation, via scripts/run_inclusion_policy_full.sh (HAZEL_MODE=1).
# Same boundary values as the other skylake experiments (see
...
# ASSUMED_LINE_SIZE_BYTES left at its default (64) -- skylake's own
...
#     hpc_slurm/hw1_skylake_inclusion_policy.sh
#
#SBATCH --job-name=hw1_inclusion_policy
#SBATCH --output=data_raw/hazel_skylake/hw1_skylake_inclusion_policy_%j.log
#SBATCH --error=data_raw/hazel_skylake/hw1_skylake_inclusion_policy_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_inclusion_policy_full.sh hazel_skylake "${CORE:-0}" \
  L1_vs_L2:32768:1048576:L1_to_L2,L2_vs_LLC:1048576:23726560:L2_to_LLC,L1_vs_LLC:32768:23726560:LLC_to_DRAM
