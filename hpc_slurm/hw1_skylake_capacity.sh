#!/bin/bash
#
# hw1_skylake_capacity.sh -- Phase-I capacity experiment, skylake generation,
...
#SBATCH --output=data_raw/hazel_skylake/hw1_skylake_capacity_%j.log
#SBATCH --error=data_raw/hazel_skylake/hw1_skylake_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_skylake "${CORE:-0}"
