#!/bin/bash
#
# hw1_turin.sh -- Phase III Hazel pilot job, turin generation.
#
...
#SBATCH --output=data_raw/hazel_turin/hw1_turin_%j.log
#SBATCH --error=data_raw/hazel_turin/hw1_turin_%j.err.log
#SBATCH --ntasks=1
...
echo "SLURM_JOB_CONSTRAINT (feature match)=${SLURM_JOB_CONSTRAINT:-turin}"
