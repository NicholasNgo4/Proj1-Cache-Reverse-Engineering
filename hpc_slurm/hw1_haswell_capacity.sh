#!/bin/bash
#
# hw1_haswell_capacity.sh -- Phase-I capacity experiment, haswell generation,
...
#SBATCH --output=data_raw/hazel_haswell/hw1_haswell_capacity_%j.log
#SBATCH --error=data_raw/hazel_haswell/hw1_haswell_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_haswell "${CORE:-0}"
