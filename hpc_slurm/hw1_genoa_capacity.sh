#!/bin/bash
#
# hw1_genoa_capacity.sh -- Phase-I capacity experiment, genoa generation,
...
#SBATCH --output=data_raw/hazel_genoa/hw1_genoa_capacity_%j.log
#SBATCH --error=data_raw/hazel_genoa/hw1_genoa_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_genoa "${CORE:-0}"
