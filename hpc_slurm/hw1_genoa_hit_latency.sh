#!/bin/bash
#
# hw1_genoa_hit_latency.sh -- Phase-I hit-latency experiment, genoa
...
#SBATCH --output=data_raw/hazel_genoa/hw1_genoa_hit_latency_%j.log
#SBATCH --error=data_raw/hazel_genoa/hw1_genoa_hit_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_hit_latency_full.sh hazel_genoa "${CORE:-0}" \
  L1:32768,L2:1048576,LLC:33554432,DRAM:536870912
