#!/bin/bash
#
# hw1_genoa.sh -- Phase III Hazel pilot job, genoa generation.
#
...
#SBATCH --output=data_raw/hazel_genoa/hw1_genoa_%j.log
#SBATCH --error=data_raw/hazel_genoa/hw1_genoa_%j.err.log
#SBATCH --ntasks=1
...
echo "SLURM_JOB_CONSTRAINT (feature match)=${SLURM_JOB_CONSTRAINT:-genoa}"
