#!/bin/bash
#
# hw1_broadwell_hit_latency.sh -- Phase-I hit-latency experiment, broadwell
...
#SBATCH --output=data_raw/hazel_broadwell/hw1_broadwell_hit_latency_%j.log
#SBATCH --error=data_raw/hazel_broadwell/hw1_broadwell_hit_latency_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_hit_latency_full.sh hazel_broadwell "${CORE:-0}" \
  L1:32768,L2:262144,LLC:25874000,DRAM:536870912
