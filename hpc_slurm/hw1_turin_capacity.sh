#!/bin/bash
#
# hw1_turin_capacity.sh -- Phase-I capacity experiment, turin generation,
...
#SBATCH --output=data_raw/hazel_turin/hw1_turin_capacity_%j.log
#SBATCH --error=data_raw/hazel_turin/hw1_turin_capacity_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_capacity_full.sh hazel_turin "${CORE:-0}"
