#!/bin/bash
#
# hw1_haswell_inclusion_policy.sh -- Phase-I inclusion/exclusion experiment,
# haswell generation, via scripts/run_inclusion_policy_full.sh (HAZEL_MODE=1).
...
# ASSUMED_LINE_SIZE_BYTES left at its default (64) -- haswell's own
...
#     hpc_slurm/hw1_haswell_inclusion_policy.sh
#
#SBATCH --job-name=hw1_inclusion_policy
#SBATCH --output=data_raw/hazel_haswell/hw1_haswell_inclusion_policy_%j.log
#SBATCH --error=data_raw/hazel_haswell/hw1_haswell_inclusion_policy_%j.err.log
#SBATCH --ntasks=1
...
HAZEL_MODE=1 ./scripts/run_inclusion_policy_full.sh hazel_haswell "${CORE:-0}" \
