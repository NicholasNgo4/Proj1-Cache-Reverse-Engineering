...
- **15 of the 15 required chronological plots produced** (`scripts/
  ...
  Sunbird and Thunderbird — but a cross-machine chronological plot needs
  data from all 8 machines, and only 2 of 8 have any `software_hit_rate`
  data collected so far. Still a known gap, just a narrower one than "the
