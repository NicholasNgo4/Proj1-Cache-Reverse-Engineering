...
item 1: started 2026-09-14, Sunbird, Thunderbird, Skylark, Crux, Ookay, and Upgrade done (6 of 8 machines).**
New pipeline
...
- **6 of 8 machines done (Sunbird, Thunderbird, Skylark, Crux, Ookay,
  Upgrade); 2 remaining** (Artemisia, Charnwood). Each needs the same command
