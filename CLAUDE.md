...
item 1: started 2026-09-14, Sunbird, Thunderbird, Skylark, and Ookay done (4 of 8 machines).**
New pipeline
...
- **4 of 8 machines done (Sunbird, Thunderbird, Skylark, Ookay); 4 remaining**
  (Artemisia, Charnwood, Crux, Upgrade). Each needs the same command
