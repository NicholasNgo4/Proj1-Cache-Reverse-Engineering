...
2026-09-13, three machines done (Sunbird, Thunderbird, Ookay), 5 outstanding.**
...
- **Not yet done on the other 5 machines (Skylark, Artemisia, Charnwood,
  Crux, Upgrade).** Whoever picks up the next one should use
  `scripts/run_pmu_verification.sh` (now the settled convention, see above)
  and read the Sunbird, Thunderbird, and Ookay writeups + their respective
