...
\centering\includegraphics[width=\linewidth]{flow_capacity.png}
\column{0.45\textwidth}
\centering\includegraphics[width=\linewidth]{sunbird_capacity.png}
\end{columns}
\begin{block}{Finding}
...
\begin{columns}[T]
\column{0.55\textwidth}
\centering\includegraphics[width=\linewidth]{flow_linesize.png}
\column{0.45\textwidth}
\centering\includegraphics[width=\linewidth]{sunbird_linesize.png}
\end{columns}
\begin{block}{Finding}
...
\begin{columns}[T]
\column{0.55\textwidth}
\centering\includegraphics[width=\linewidth]{flow_assoc.png}
\column{0.45\textwidth}
\centering\includegraphics[width=\linewidth]{sunbird_assoc_L1.png}
\end{columns}
\begin{block}{Finding}
...
\begin{columns}[T]
\column{0.5\textwidth}
\centering\includegraphics[width=\linewidth]{flow_hitlat.png}
\column{0.5\textwidth}
\centering
...
\begin{columns}[T]
\column{0.5\textwidth}
\centering\includegraphics[width=\linewidth]{flow_misslat.png}
\column{0.5\textwidth}
\centering
...
\begin{columns}[T]
\column{0.55\textwidth}
\centering\includegraphics[width=\linewidth]{flow_inclusion.png}
\column{0.45\textwidth}
\centering\includegraphics[width=\linewidth]{sunbird_incl_L1_vs_L2.png}
\end{columns}
\begin{block}{Finding}
...
\begin{columns}[T]
\column{0.5\textwidth}
\centering\includegraphics[width=\linewidth]{flow_hitrate.png}
\column{0.5\textwidth}
\centering\includegraphics[width=0.95\linewidth]{chrono_14_software_hit_rate.png}
\end{columns}
\begin{block}{Finding}
...
% ============================================================
\begin{frame}{Our Laws}
\begin{block}{Law 1 -- Chen--Ngo Cache Capacity Doubling Law}
$C(t) = 256\,\text{KiB}\cdot 2^{(t-2014)/\tau}$, $\tau = 3$ years (fit: Sunbird 2014
$\to$ Artemisia 2023, an exact $8\times$ over 9 years, step-wise not smooth).
\emph{Hazel-Haswell:} evaluated at the model's own 2014 fit endpoint (256\,KiB) --
\textbf{untestable this pass}, Hazel's own L2 boundary was never cleanly resolved.
\end{block}
\begin{block}{Law 2 -- Chen--Ngo Cache Invariance Law}
L1D capacity/associativity/line size are approximately constant across a decade and 3
vendors (32,768\,B / 8-way / 64\,B on 6 of 8 machines). \emph{Hazel-Haswell:}
\textbf{supported, exact match} on all three -- the law's own stated scope (an x86 Xeon
target) is precisely where it held with no exceptions.
\end{block}
\end{frame}
