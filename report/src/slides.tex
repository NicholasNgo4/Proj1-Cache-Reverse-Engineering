...
$\to$ Artemisia 2023 ($8\times$/9\,yr, step-wise). Dashed = frozen extrapolation to 2028
($\sim$6.35\,MiB). Hazel's own L2 boundary never resolved -- \textbf{untestable this pass}.\\[1pt]
\textbf{Law 2 (Invariance):} L1D capacity/assoc./line size constant across a decade, 3
vendors (32,768\,B / 8-way / 64\,B, 6 of 8 machines); dashed line reverts to that majority
value, not a fit through Artemisia's outlier. Hazel-Haswell (star) matched exactly --
\textbf{supported}.
\end{block}
\end{frame}
